...
def soft_constraints(schedule, courses, schedule_counter):
    ...
    while schedule_counter < CYCLES:
        ...
        if accept_counter > OPTIMUM:
            ...
            print("Bonuspoints: ", Constraint.session_spread_check(schedule, courses, info)[0], "Maluspoints: ", Constraint.students_fit(schedule, courses, info))
            ...
            schedule = switch.switch_session(schedule, 30, -1)
